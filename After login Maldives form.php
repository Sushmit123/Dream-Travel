...
$query="INSERT INTO `maldives`( `name`, `username`, `password`, `adults`, `childern`, `mobile`, `pickup`, `destination`, `depature`, `seat`) 
    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 login-left">
                    <center><h2>Book Form of Maldives </h2></center>
                    ...
                    <div class="form-group-one">
                        ...
                        <div class="form-group-five" >
                            <label>Pick up address: <span>Delhi Airport,Delhi </span></label>
                            <input type="radio" id="html" name="pickup" value="Delhi Airport,Delhi">
                        </div>
                      
                        
                        <div class="form-group-five" >
                            <label> Destination address: <span> Maldives</span></label>
                            <input type="radio" id="html" name="destination" value="Maldives">
                        </div>
