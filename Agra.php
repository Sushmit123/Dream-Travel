...
/* family tour end */    
    ...
    <div id="services">
          <div class="box">
            <center>  <img  class="img"src="agra1.jpg" alt="" width="30%" >
              <img  class="img"src="agra2.jpg" alt=""width="30%" >
              <img  class="img"src="agra3.jpg" alt=""width="32%" >
             </center> <!-- <img  class="img"src="agra2.jpg" alt=""width="22%" > -->
             
              
             <h1 style="position: relative; left:-19%; top:20%" >Agra</h1>
<h2>Agra's notable historical period began during Sikandar Lodi's reign, but the golden age of the city
 began with the Mughals. Agra was the foremost city of the Indian subcontinent and the capital of the Mughal Empire under Mughal emperors Babur, Humayun, Akbar, Jahangir and Shah Jahan. Under Mughal rule, Agra became a centre for learning, arts, commerce, and religion, and saw the construction of the Agra Fort, Sikandra and Agra's most prized monument, the Taj Mahal, built by Shah Jahan as a mausoleum for his favourite empress. </h2>
<bR>
<h2>Capital:Uttar Pradesh </h2>
<br>
<h2>BEST TIME TO VISIT Agra:
If travelling to Agra, October to March. season would be the best time to visit</h2>
<br>
<h2>Price: Rs:5000</h2>
