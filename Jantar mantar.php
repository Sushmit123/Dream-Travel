...
/* family tour end */      
    ...
    <div id="services">
          <div class="box">
              ...
              <center><h1 >Jantar mantar</h1></center>
               <h2> Jaipur is located in northwestern India, bounded on the west and northwest by Pakistan and shares domestic borders with the states of Punjab, Haryana, Uttar Pradesh, Madhya Pradesh and Gujarat. With a land area of 342,239 sq km, Rajasthan is the largest state in India geographically.8 The state is divided into 33 districts and comprises nine regions – Ajmer State, Hadoti, Dhundhar, Gorwar, Shekhawati, Mewar, Marwar, Vagad and Mewat.9</h2>
                <br>
