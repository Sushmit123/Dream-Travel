...
$query="INSERT INTO `Jantar mantar`( `name`, `username`, `password`, `adults`, `childern`, `mobile`, `pickup`, `destination`, `depature`, `seat`) 
...
<html>
    <head>
        <title>Jantar mantar Form</title>
    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 login-left">
                    <center><h2>Book Form of Jantar mantar </h2></center>
                    ...
                    <div class="form-group-one">
                        ...
                        <div class="form-group-five" >
                            <label> Destination address: <span> Jantar manatr</span></label>
                            <input type="radio" id="html" name="destination" value="Jantar manatr">
                        </div>
