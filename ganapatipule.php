...
$query="INSERT INTO `ganpatipule`(`name`, `username`, `password`, `adults`, `children`, `mobile`, `pickup`, `destination`, `depature` , `seat` ) 
    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 login-left">
                    <center><h2>Book Form of Ganapatipule </h2></center>
                    ...
                    <div class="form-group-one">
                        ...
                        <div class="form-group-five" >
                            <label>Pick up address: <span> Teen Hath Naka,Thane</span></label>
                            <input type="radio" id="html" name="pickup" value="Teen Hath Naka,Thane">
                        </div>
                      
                        
                        <div class="form-group-five" >
                            <label> Destination address: <span> Ganapatipule,Ratnagiri</span></label>
                            <input type="radio" id="html" name="destination" value="Ganapatipule,Ratnagiri">
                        </div>

                        <div class="form-group-five" >
                            <label> Departure Date/Time : <span> 20 September 2021 9.00pm</span></label>
                            <input type="radio" id="html" name="departure" value="20 September 2021 9.00pm">
                        </div>
