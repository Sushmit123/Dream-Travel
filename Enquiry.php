...
$query= "INSERT INTO `enquiry`( `email`, `password`, `enquiry`) VALUES ('$email','$password','$enquiry')";

$data=mysqli_query($conn,$query);

if($data){
   
    echo '<script>alert(" Our customer service contact you soon")</script>';
}
else{
    ...
    <header id="header">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <h1  style="background-color:red;color:aqua;"><center>Contact us from</center></h1>
                     <h2>Name: Abc  <br>
                         Moible no: +91 1234567890</h2>
                    <h2  style="background-color:light grey;color:Black;"><center>OR </center></h2>
                  <h1 style="background-color:red;color:aqua;"><center>Enquiry </center></h1>
                    ...
                    <form action="" method="POST">
                        ...
                        <br>
                        <button type="submit" class="btn btn-primary" name="submit"> Enquiry </button>
