...
/* family tour end */    
    ...
    <header id="header">
        ...
        <div id="services">
          <div class="box">
              <img  class="img"src="agra1.jpg" alt="">
              <center><h2 >Agra</h2></center>
...
Dinner
<br><br>
Day:7Departure from Delhi
Board the train / flight to your hometown. Tour Concludes.</p>
    
<button> <a href="After login agra form.php">Book</button> <button> <a href="Enquiry.php">Enquiry</button></a>
</div>
