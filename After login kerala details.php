...
/* family tour end */    
    ...
    <header id="header">
        ...
        <div id="services">
          <div class="box">
              <img  class="img"src="kerala2.jpg" alt="">
...
Dinner
<br><br>
Day:3 Kerala – Thiruvananthapuram 
...
Dinner
<br><br>
Day:7Departure from Kerala
Board the train / flight to your hometown. Tour Concludes.</p>
    
<button> <a href="After login kerala form.php">Book</button> <button> <a href="Enquiry.php">Enquiry</button></a>
</div>
