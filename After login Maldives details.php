    ...
    <header id="header">
            ...
            <ul>
              ...
              <ul>
                ...
                <li><a href="Enuiry.php">Contact us</a></li>
        ...
        <div id="services">
          <div class="box">
              <img  class="img"src="Maldives2.jpg" alt="">
              <center><h2 >Maldives</h2></center>
...
Extra Topping : Frooti at Goa Airport.
Dinner
<br><br>
Day:2Goa – City Tour
Enjoy city tour of Goa. Photo stop at Hawa Mahal literally means Palace of winds. Explore City Palace and Jantar Mantar - an astronomical observatory built by Sawai Jai Singh. Later visit Amer Fort - known for its artistic style elements, large ramparts and series of gates and cobbled paths. In the evening fee time for shopping.
...
<br><br>
Day:3 Gao – Panaji
Today proceed to Panaji. On arrival visit Moinuddin Chishti Dargah – a holy place where Khwaja Moinuddin enshrined his secular preachings. Later Proceed to Pushkar. Visit Pushkar Tirth and Bramha Mandir at Pushkar.
...
Dinner
<br><br>
Day:7Departure from Goa
Board the train / flight to your hometown. Tour Concludes.</p>
    
<button> <a href="After login Maldives form.php">Book</button> <button> <a href="Enquiry.php">Enquiry</button></a>
</div>
