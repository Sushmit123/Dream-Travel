...
/* family tour end */    
    ...
    <div id="services">
          <div class="box">
            <center>  <img  class="img"src="nainital6.jpg" alt="" width="30%" >
              <img  class="img"src="nainital6.jpg" alt=""width="30%" >
              <img  class="img"src="nainital5.jpg" alt=""width="30%" >
             </center>
             
              
             <h1 style="position: relative; left:50%; top:20%" >Nainital</h1>
<h2>Nainital is located in the Kumaon foothills of the outer Himalayas at a distance of 285 km (177 mi) from the 
state capital Dehradun and 345 km (214 mi) from New Delhi, the capital of India. Situated at an altitude of 1,938 metres 
(6,358 ft) above sea level, the city is set in a valley containing an eye-shaped lake, approximately two miles in circumference,
 and surrounded by mountains, of which the highest are Naina Peak (2,615 m (8,579 ft)) on the north </h2>
<bR>
<h2>Capital:uttrakhand </h2>
<br>
<h2>BEST TIME TO VISIT Nainital:
If travelling to Nainital, March to June. season would be the best time to visit</h2>
<br>
<h2>Price Rs2000</h2>
