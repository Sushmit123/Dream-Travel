...
/* family tour end */    
    ...
    <div id="services">
          <div class="box">
            <center>  <img  class="img"src="kerala1.jpg" alt="" width="23%" >
              <img  class="img"src="kerala2.jpg" alt=""width="23%" >
              <img  class="img"src="kerala3.jpg" alt=""width="23%" >
              <img  class="img"src="kerala4.jpg" alt=""width="23%" ></center>
             
              
             <h1 style="position: relative; left:-25%; top:25%" >Kerala</h1>
              <h2>It was formed on 1 November 1956, following the passage of the States Reorganisation Act, 
by combining Malayalam-speaking regions of the erstwhile regions of Cochin, Malabar, South Canara, and Travancore. 
Spread over 38,863 km2 (15,005 sq mi), Kerala is the twenty-first largest Indian state by area. It is bordered by Karnataka 
to the north and northeast, Tamil Nadu to the east and south, and the Lakshadweep Sea[16] to the west. With 33 million inhabitants
 as per the 2011 census,  </h2>
<bR>
<h2>Capital:Thiruvananthapuram  </h2>
<br>
<h2>BEST TIME TO VISIT KERALA:
If travelling to kerala October to February season would be the best time to visit</h2>
<br>
<h2>Price Rs 1000</h2>
