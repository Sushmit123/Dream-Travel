...
/* family tour end */    
    ...
    <div id="services">
          <div class="box">
            <center>  <img  class="img"src="Maldives1.jpg" alt="" width="24%" >
              <img  class="img"src="Maldives2.jpg" alt=""width="24%" >
              <img  class="img"src="Maldives3.jpg" alt=""width="21%" >
              <img  class="img"src="Maldives4.jpg" alt=""width="24%" ></center>
             
              
             <h1 style="position: relative; left:-25%; top:20%" >Maldives</h1>
              <h2>Straddling the equator, washed by the warm waters of the Indian Ocean,
                   the Maldivian archipelago has 1,190 small and low lying coral islands slung over 90,000 square kilometers of tropical sea 
                   offering an astounding variety of attractions that is unparalleled anywhere else.
The Maldives is an up market luxury destination where many resorts are on the "who's who" l
ist of elite experiences. To reinforce this image and the fact that they are a country of islands where usually everything is imported nothing is 
inexpensive. </h2>
<bR>
<h2>Capital:Male   </h2>
<br>
<h2>BEST TIME TO VISIT MALDIVES:
If travelling to Malaives, November and April season would be the best time to visit</h2>
<br>
