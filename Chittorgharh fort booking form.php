...
$query="INSERT INTO `Chittorgharh fort`( `name`, `username`, `password`, `adults`, `childern`, `mobile`, `pickup`, `destination`, `depature`, `seat`) 
...
<html>
    <head>
        <title>Chittorgharh fort Form</title>
    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 login-left">
                    <center><h2>Book Form of Chittorgharh fort </h2></center>
                    ...
                    <div class="form-group-one">
                        ...
                        <div class="form-group-five" >
                            <label> Destination address: <span> Chittorgharh fort</span></label>
                            <input type="radio" id="html" name="destination" value="Chittorgharh fort">
                        </div>
