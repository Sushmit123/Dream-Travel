...
$query="INSERT INTO `raigad`( `name`, `username`, `password`, `adults`, `childern`, `mobile`, `pickup`, `destination`, `depature`, `seat`) 
    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 login-left">
                    <center><h2>Book Form of Raigad </h2></center>
                    ...
                    <div class="form-group-one">
                        ...
                        <div class="form-group-five" >
                            <label> Destination address: <span> Raigad</span></label>
                            <input type="radio" id="html" name="destination" value="Raigad">
                        </div>
