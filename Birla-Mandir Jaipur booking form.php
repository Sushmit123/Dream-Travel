...
$query="INSERT INTO `Birla Mandir`( `name`, `username`, `password`, `adults`, `childern`, `mobile`, `pickup`, `destination`, `depature`, `seat`) 
    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 login-left">
                    <center><h2>Book Form of Birla Mandir </h2></center>
                    ...
                    <div class="form-group-one">
                        ...
                        <div class="form-group-five" >
                            <label> Destination address: <span> Birla Mandir</span></label>
